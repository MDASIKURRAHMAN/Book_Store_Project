                ...
                <div id="myCarousel" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        <div class="active item carousel-item" data-slide-number="0">
                            <img src="asik/images/4.jpg" class="img-fluid">
                        </div>
            ...
            <div class="col-md-6 slider-content">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <span class="price">tk 520</span>
                    </li>
                    <li>
                        <span class="name">Kindle Price</span><span class="clm">:</span>
                        <span class="price final">tk 111</span>
                    </li>
                    <li><span class="save-cost">Save tk 409 (15%)</span></li>
                </ul>
                <div class="btn-sec">
